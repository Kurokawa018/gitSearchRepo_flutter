...
// in yumemi_flutter/test/widget_test.dart.
...
import 'package:yumemi_flutter/model/API_model.dart' as _i6;
...
/// A class which mocks [GithubModel].
///
/// See the documentation for Mockito's code generation for more information.
class MockGithubModel extends _i1.Mock implements _i6.GithubModel {
  @override
  ...
  @override
  List<dynamic> get items => (super.noSuchMethod(
  ...
  @override
  set items(List<dynamic>? _items) => super.noSuchMethod(
        Invocation.setter(
          #items,
          _items,
        ),
  ...
  @override
  set isEmpty(bool? _isEmpty) => super.noSuchMethod(
        Invocation.setter(
          #isEmpty,
          _isEmpty,
        ),
  ...
  @override
  bool get isSearched => (super.noSuchMethod(
        Invocation.getter(#isSearched),
        returnValue: false,
        returnValueForMissingStub: false,
      ) as bool);

  @override
  set isSearched(bool? _isSearched) => super.noSuchMethod(
        Invocation.setter(
          #isSearched,
          _isSearched,
        ),
  ...
  @override
  set isError(bool? _isError) => super.noSuchMethod(
        Invocation.setter(
          #isError,
          _isError,
        ),
  ...
  @override
  _i3.Future<void> search(String? query) => (super.noSuchMethod(
        Invocation.method(
          #search,
          [query],
        ),
  ...
  @override
  _i3.Future<List<dynamic>> fetchRepositories(String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchRepositories,
          [query],
  ...
  @override
  void endLoading() => super.noSuchMethod(
        Invocation.method(
          #endLoading,
          [],
        ),
  ...
  @override
  void onChanged() => super.noSuchMethod(
        Invocation.method(
          #onChanged,
          [],
        ),
